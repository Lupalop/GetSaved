...
{
    /// <summary>
    /// This is a game component that implements ObjectBase.
    /// </summary>
    public class ProgressBar : ObjectBase
    {
        ...
        public ProgressBar(string ObjectName, Rectangle rect, Orientation orientation, SceneManager sceneManager)
            : base (ObjectName)
        {
            this.sceneManager = sceneManager;
            m_borderOuterRect = rect;
        ...
        /// <param name="height">Height of the progress bar.</param>
        /// <param name="orientation">The orientation of the progress bar.</param>
        public ProgressBar(string ObjectName, Int32 x, Int32 y, Int32 width, Int32 height, Orientation orientation, SceneManager sceneManager)
            : base (ObjectName)
        {
            this.sceneManager = sceneManager;
            m_borderOuterRect = new Rectangle(x, y, width, height);
