...
namespace Arkabound.Components
{
    public class FPSCounter : DrawableGameComponent
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (KeybdState.IsKeyDown(Keys.F2)) isFPSVisible = true;
            if (KeybdState.IsKeyUp(Keys.F2)) isFPSVisible = false;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            string fps = string.Format("FPS: {0}, Memory: {1}", frameRate, GC.GetTotalMemory(false));
            if (isFPSVisible)
            {
                spriteBatch.Begin();
